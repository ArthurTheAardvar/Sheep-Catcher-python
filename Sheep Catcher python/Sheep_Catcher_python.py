...
pigPic = pygame.image.load("cow1.jpg")
...
def sheepMove(position):
    ...
    elif position[2] == DOWN and position[1]+80 <=800:
...
sheep2 = [300, 400, LEFT, False]
sheep3 = [400, 400, UP, False]
pig4 = [500, 400, DOWN, False]
pig5 = [600, 400, RIGHT, False]
...
while score<5: #GAME LOOP############################################################
    ...
    collision(xpos, ypos, pig4)
    collision(xpos, ypos, pig5)
    ...
    if pig4[3] == False: #don't draw them if they're already caught!
        #pygame.draw.rect(screen, (250, 100, 100), (sheep1[0], sheep1[1], 40, 40)) #use this if you don't have a jpg
        screen.blit(pigPic, (pig4[0], pig4[1]))
    if pig5[3] == False: #don't draw them if they're already caught!
        #pygame.draw.rect(screen, (250, 100, 100), (sheep1[0], sheep1[1], 40, 40)) #use this if you don't have a jpg
        screen.blit(pigPic, (pig5[0], pig5[1]))
